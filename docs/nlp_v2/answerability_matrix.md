...
| **Metro Point-to-Point Fare** | "Central se Guindy metro ka ticket kitne ka hai?" | `ANSWERABLE_NOW` | `cmrl_station_fares` (41x41 matrix, 1,681 OD pairs) | Return exact statutory fare for Single Journey Token (SJT) and 20% discounted Smart Card/QR from official CMRL fare matrix. |
