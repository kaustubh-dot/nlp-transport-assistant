...
- Reference Documents: [kb_answerability_audit.md](../../reports/nlp_v2/kb_answerability_audit.md), [answerability_matrix.md](answerability_matrix.md).
...
- Reference Document: [intent_taxonomy_candidates.md](intent_taxonomy_candidates.md).
...
- Reference Documents: [slot_schema.md](slot_schema.md), [entity_resolution_contract.md](entity_resolution_contract.md).
...
- Reference Document: [language_and_robustness_spec.md](language_and_robustness_spec.md).
...
- Reference Documents: [dataset_contract.md](dataset_contract.md), [split_and_leakage_policy.md](split_and_leakage_policy.md).
...
- Reference Documents: [evaluation_protocol.md](evaluation_protocol.md), [experimental_preregistration.md](experimental_preregistration.md).

---

## 4. Open Decisions Requiring User Approval

Before the research program advances past Gate A into Gate B (Taxonomy Pilot Implementation), the user must review and approve three key methodological decisions documented in [DECISION_REQUIRED.md](../../DECISION_REQUIRED.md):
