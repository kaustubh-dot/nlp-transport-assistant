...
| 4 | **MTC Official Route / Stage Information** | `data/raw/mtc/2026-09-18/mtc_official_routes.html`<br>`data/raw/mtc/2026-09-18/mtc_official_stages.html` | `COLLECTED_AND_INGESTED` | Acquired official MTC route directory (685 routes) and official stage directory (1,562 stages) directly from `https://mtcbus.tn.gov.in/Home/routewiseinfo` and `https://mtcbus.tn.gov.in/Home/stagewiseinfo`. |
| 5 | **MTC Official Schedules** | `data/raw/mtc/2026-09-18/` | `PARTIAL` | Route-by-route and stage timings exist via interactive query form (`https://mtcbus.tn.gov.in/Home/bustimingsearch`), but MTC does not publish a bulk downloadable static timetable file. Scheduled trips are supplemented via GTFS `stop_times.txt` (47,149 trips). |
| 6 | **MTC Official Fare Information** | `data/raw/mtc/2026-09-18/mtc_official_fares.html` | `COLLECTED_AND_INGESTED` | Ingested official MTC fare list and stage fare matrix directly from `https://mtcbus.tn.gov.in/Home/fares`. |
...
| 11 | **Community GTFS** | `data/raw/community_gtfs/2026-09-18/chennai-unified-gtfs.zip` | `COLLECTED_AND_INGESTED` | 8.7MB unified GTFS (ODbL) containing 5,624 stops, 4,614 route variants, 47,149 trips, and 1,360,635 stop times preserved as independent Tier-3 overlapping evidence. |
...
| File ID | Byte Size | Format | SHA-256 Checksum |
|---------|-----------|--------|------------------|
| `CUMTA_CMA_BOUNDARY_20260918` | 156,235 | GeoJSON | `0e5416833cebddd9f22810e7c3cac97e8693d0b388fd17ce067153b716fc7d8c` |
| `CMRL_WP_API_20260918` | 301,868 | JSON | `dcbc36f7477d770bc4cadfe19c18eadef508b4b9073d50265da4ec48c1d9ba58` |
| `CMRL_PHASE2_STATUS_20260918` | 88,589 | HTML | `aef283a4b3183636f1c42f0a597a159f807eaec20853580572e816a2ef86ca84` |
| `CMRL_PHASE2_MAP_20260918` | 3,342,142 | PDF | `d2f0bef6f35c848ae424076e036e4f346e91ea6b67fe19a3b93f2f01ebae2cb8` |
| `MTC_FARES_20260918` | 110,759 | HTML | `3abb45898ee0c773e34b9d034db1b453a233b87fe2e4a42b10221379ec68ea13` |
| `MTC_ROUTES_20260918` | 88,683 | HTML | `15966686d915d2745cf6b48a04b12738fa09ee068be41369eb3c3b0be25c8d08` |
| `MTC_STAGES_20260918` | 304,439 | HTML | `738b1c05c8a1908e3328e36780c109fcfe7a35fe6398f8045934526019b78e47` |
| `CHENNAI_UNIFIED_GTFS_20260918` | 9,091,816 | ZIP | `db1da880f9ad93e352f6658df0e94a8b2d71cd1dc8bdfbb60fa3968a9b0ad3e6` |
| `OSM_RAIL_METRO_STATIONS_20260918` | 162,041 | JSON | `b114790e5d0bd221b7feea4455a9a510181468b79f540310d040cbf37499cc5b` |
| `OSM_BUS_TERMINALS_STOPS_20260918` | 420,643 | JSON | `5178bd61f268477ce55a365b30203ab3512c515a7649d15fbafd205f9f8fb3d9` |
| `OSM_TRANSPORT_POIS_20260918` | 650,688 | JSON | `7a3cdf4a7feafaa5531072e38b88ca92fa35775b2a90aa7fae7c5396c395d2cb` |
